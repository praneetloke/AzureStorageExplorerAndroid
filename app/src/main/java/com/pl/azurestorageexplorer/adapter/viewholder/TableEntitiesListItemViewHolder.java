 ...
 */
public class TableEntitiesListItemViewHolder extends RecyclerView.ViewHolder implements View.OnClickListener {
    public TextView partitionKey;
    public TextView rowKey;
    public LinearLayout layout2;
    private IViewHolderClickListener listener;

    public TableEntitiesListItemViewHolder(View itemView, IViewHolderClickListener viewHolderClickListener) {
        super(itemView);
