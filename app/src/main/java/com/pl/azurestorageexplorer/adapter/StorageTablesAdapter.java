 ...
 */
public class StorageTablesAdapter extends SpinnerArrayAdapter<StorageTableSerializable> {

    public StorageTablesAdapter(Context context, ArrayList<StorageTableSerializable> tables) {
        super(context, android.R.layout.simple_spinner_item, tables);
    }
